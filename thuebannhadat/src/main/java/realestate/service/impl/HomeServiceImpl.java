...
public class HomeServiceImpl implements HomeService {
	...
	public List<Notification> getAllNotificationByUserName(String userName) {
		...
		List<Notification> lstNotification = abstractDao.findAllByParameter(Notification.class, parameters, "HomeDao.getAllNotificationByUserName",
				null, null);
	...
	public List<PostSpecification> getPostSpecification(Integer postTypeId, Date endDate, int limit, int offset) {
		...
		List<PostSpecification> lstPostSpecification = abstractDao.findAllByParameter(PostSpecification.class, parameters, "HomeDao.getPostSpecification",
				limit, offset);
		return lstPostSpecification;
	}
