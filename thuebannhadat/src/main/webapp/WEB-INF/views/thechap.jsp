        ...
        <div class="wrap">
            ...
            <div class="con pdl pdr">
                <div class="breadcrumb bec-fu">
                    <ul>
                        ...
                        <li><a href="thechap.html">Thế Chấp</a></li>
            ...
            <div class="con pda">
                <div class="tit">
                    ...
                    <div class="act">
                        ...
                        <a href="thechap-list.html" class="more a"><span class="smtext">Xem tất cả</span> <span class="fa fa-angle-right"></span></a>
                    </div>
                </div>
                <div class="hot-items">
                    <div>
            ...
            <div class="con cls-after">
                ...
                <div class="con-left pda">
                    ...
                    <!-- SALE BEGIN -->
                    <div class="tit mgt">
                        <p>NHÀ ĐẤT THẾ CHẤP</p>
                        <div class="act">
                            <a href="thechap-list.html" class="more a"><span class="smtext">Xem tất cả</span> <span class="fa fa-angle-right"></span></a>
                        </div>
                    </div>
                    <div class="items cls-after">
                        <div class="item cls-after">
                            ...
                            <div class="info">
                                ...
                                <table>
                                    <tr>
                                        <th colspan="6"><a href="JavaScript:void(0)">Biệt thự Golden</a></th>
                                    </tr>
                                    <tr>
                    ...
                    <div class="paging">
                        <ul>
                            <li><a href="thechap.html"><span class="fa fa-angle-double-left"></span></a></li>
                            <li><a href="thechap.html"><span class="fa fa-angle-left"></span></a></li>
                            <li class="active"><a href="thechap.html">1</a></li>
                            <li><a href="thechap2.html">2</a></li>
                            <li><a href="thechap2.html"><span class="fa fa-angle-right"></span></a></li>
                            <li><a href="thechap2.html"><span class="fa fa-angle-double-right"></span></a></li>
                        </ul>
                    </div>
                    <!-- PAGING END -->
                </div>
