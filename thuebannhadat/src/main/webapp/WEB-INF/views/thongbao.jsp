                ...
                <div class="con-right pda">
                    <div class="acc-info">
                        ...
                        <ul>
                            ...
                            <li class=""><a href="quanly.html"><span class="fa fa-newspaper-o"></span> Quản Lý Tin</a></li>
                            ...
                            <li class="active"><a href="thongbao.html"><span class="fa fa-bell-o"></span> Thông báo mới <i class="numof">5</i></a></li>
                    ...
                    <div data-step="2-1" id="step2-1" class="open ">
                        ...
                        <div class="box mgt">
                            <table class="histable colors">
                                <tr>
                                    <td >
                                        <div class="fx0">[Lorem Ipsum] is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</div>
                                    </td>
                                    <td width="100">
                                        <div class="fx0"><div class="fa fa-history"></div> 2016/10/12</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td >
