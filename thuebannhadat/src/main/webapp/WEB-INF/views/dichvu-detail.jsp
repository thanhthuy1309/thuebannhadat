    ...
    <body class="">
        ...
        <div class="wrap">
            ...
            <div class="banner cover" style="background-image:url(${pageContext.request.contextPath}/resources/images/15.jpg)">
                <div class="con">
                    <div class="tit-big">DỊCH VỤ MÔI GIỚI</div>
                    <div class="breadcrumb">
                        <ul>
                            <li><a href="index.html"><i class="fa fa-home"></i> Trang Chủ</a></li>
                            <li><a href="dichvu.html">Dịch vụ môi giới</a></li>
                            <li><a href="dichvu.html">Doanh nghiệp/Công ty</a></li>
            ...
            <div class="con cls-after">
                ...
                <div class="con-left pda">
                    ...
                    <div class="dv-info cls-after">
                        <div class="nailthumb">
                            <div class="nailthumb-figure-75">
                                <a href="dichvu-detail.html" class="nailthumb-container">
                                    <img class="lazy" src="${pageContext.request.contextPath}/resources/images/13.png">
                                </a>
                            </div>
                        </div>
                        <div>
                            ...
                            <span class="fa fa-globe"></span> http://novaland.com<br/>
                            </p>
                    ...
                    <div id="owl-service" class="owl-carousel owl-news">
                    <!-- <div class="news-items cls-after"> -->
                        <div class="news-item">
                            ...
                            <div class="info" style="height:190px">
                                <a href="chitiet.html" class="h2"><span>[Lorem Ipsum] is simply dummy text of the printing and typesetting industry</span></a>
                                <div style="padding:10px 0">
                                    <span class="fa fa-map-marker"></span> Địa chỉ 108 Tôn Đức Thắng, P. Bến Thành, Q.1, TP.HCM<br/>
                                    <span class="fa fa-phone"></span> 09xx xxxx xxx/09xx xxxx xxx
                                </div>
                                <div>
                                    <div class="hr"></div>
                                    <div class="pdt pdb">
                                        <span class="fa fa-file-text-o"></span> 5 Dự án
                                        <span class="pull-right"><i class="fa fa-building-o"></i> 3 Sàn giao dịch</span>
                                    </div>
                                </div>
                                <a href="chitiet.html" class="yellow-btn block-btn hvr-bounce-to-bottom">Chi Tiết</a>
                            </div>
                        </div>
                        <div class="news-item">
                            <div class="nailthumb">
