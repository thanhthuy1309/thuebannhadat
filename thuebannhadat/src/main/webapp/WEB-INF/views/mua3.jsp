            ...
            <div class="con cls-after">
                ...
                <div class="con-left pda">
                    ...
                    <div class="tit mgt">
                        <p>NHÀ ĐẤT MUA</p>
                        <div class="act">
                            <a href="mua.html" class="more a"><span class="smtext">Xem tất cả</span> <span class="fa fa-angle-right"></span></a>
                        </div>
                    </div>
                    ...
                    <div class="paging">
                        <ul>
                            ...
                            <li><a href="mua2.html"><span class="fa fa-angle-left"></span></a></li>
                            <li ><a href="mua.html">1</a></li>
                            <li><a href="mua2.html">2</a></li>
                            <li  class="active"><a href="mua3.html">3</a></li>
                            <li><a href="mua4.html">4</a></li>
                            <li><a href="mua5.html">5</a></li>
                            <li><a href="mua6.html">6</a></li>
                            <li><a href="mua4.html"><span class="fa fa-angle-right"></span></a></li>
