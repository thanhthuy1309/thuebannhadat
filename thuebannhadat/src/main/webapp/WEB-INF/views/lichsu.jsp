...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/lib/crop/cropper.js"></script>
                ...
                <div class="con-right pda">
                    <div class="acc-info">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="lichsu.html"><span class="fa fa-history"></span> Lịch sử giao dịch</a></li>
