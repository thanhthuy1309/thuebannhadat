    ...
    <body class="">
        ...
        <div class="wrap">
            ...
            <div class="con cls-after">
                <div class="pda">
                    <div class="tit">
                        <p>NHÀ MÔI GIỚI NỔI BẬT</p>
                        <div class="act">
                            <a href="moigioi-list.html" class="more a"><span class="smtext">Xem tất cả</span> <span class="fa fa-angle-right"></span></a>
                        </div>
                    </div>
                    <div id="owl-news" class="owl-carousel owl-news services">
                    <!-- <div class="news-items cls-after"> -->
                        <div class="news-item">
                            ...
                            <div class="info">
                                <div class="starts">
                                    <a href="tintuc-detail.html" class="h2">
                                        <span>NGUYEN VAN TEO A</span>
                                    </a>
                                    <div>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td class="2"><span class="fa fa-user-secret"></span> Moi gioi tai quan 1,2,3</td>
                                        <td class="td-more" ><a href="moigioi-detail.html" class="yellow-btn">CHI TIẾT <span class="fa fa-angle-right"></span></a></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                        <div class="news-item">
                            <div class="nailthumb">
                                <div class="nailthumb-figure-75">
                                    <a href="moigioi-detail.html" class="nailthumb-container">
                                        <img class="lazy" src="${pageContext.request.contextPath}/resources/images/23.jpg">
                                    </a>
                                </div>
                            </div>
                            <div class="info">
