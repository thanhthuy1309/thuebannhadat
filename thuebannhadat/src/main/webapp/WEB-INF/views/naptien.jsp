            ...
            <div class="con cls-after">
                ...
                <div class="con-right pda">
                    <div class="acc-info">
                        ...
                        <ul>
                            ...
                            <li ><a href="dangtin.html"><span class="fa fa-edit"></span> Đăng Tin</a></li>
                            ...
                            <li class="active"><a href="naptien.html"><span class="fa fa-money"></span> Nạp tiền</a></li>
                ...
                <div class="con-left pda">
                    ...
                    <div data-step="2-2" id="step2-2" class="">
                        ...
                        <div class="err-box text-center">
                            <div class="red" style="color:#ed1b24"><span class="fa fa-4x fa-warning"></span></div>
                            <div class="tit-big2">Thất Bại, Không kết nối được với server.</div>
                            <p class="pda">Vui lòng thử lại</p>
                            <div class="pda">
                                <button class="yellow-btn" type="button" onclick="GotoStep('2-3')">THỬ LẠI</button>
                            </div>
                        </div>
                    </div>
                    <div data-step="2-3" id="step2-3" class="">
                        ...
                        <div class="noti-box text-center">
                            ...
                            <div class="pda">
                                <a class="yellow-btn" type="button"  href="dangtin.html">TIẾP TỤC</a>
                            </div>
                        </div>
                    </div>
                </div>
