    ...
    <body class="">
        ...
        <div class="wrap">
            ...
            <div class="banner cover" style="background-image:url(${pageContext.request.contextPath}/resources/images/15.jpg)">
                <div class="con">
                    <div class="tit-big">Di dời khẩn cấp chung cư</div>
                    <div class="breadcrumb">
                        <ul>
                            <li><a href="trangchu.html"><i class="fa fa-home"></i> Trang Chủ</a></li>
                            <li><a href="tintuc.html">Tin Tức</a></li>
                            <li><a href="tintuc-list.html">Chính sách quản lý</a></li>
                            <li><span>Di dời khẩn cấp chung cư</span></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="con cls-after">
                <!-- LEFT BEGIN -->
                <div class=" pda">
                    <div class="gray pdb"><span class="fa fa-user"></span> Nova Land Group | <span class="fa fa-history"></span> 2016/12/12</div>
