    ...
    <body class="">
        ...
        <div class="wrap">
                ...
                <div>
                    ...
                    <div>
                        <form name="phoneFrm" id="phoneFrm" class="frm">
                            ...
                            <div class="ctrl pdb">
                                <input class="txt txt-border validate[required]" data-prompt-position="topLeft:0,26" placeholder="Email của bạn" type="text">
                            </div>
                            <div class="ctrls pdt cls-after">
                                ...
                                <div>
                                    <button class="block-btn yellow-btn" type="button" onclick="GotoStep(2)">XÁC NHẬN</button>
                                </div>
                            </div>
                        </form>
                    ...
                    <div>
                        <form name="codeFrm" id="codeFrm" class="frm">
                            ...
                            <div class="ctrls pdt cls-after">
                                ...
                                <div>
                                    <button class="block-btn yellow-btn" type="button" onclick="GotoStep('3');login()">NHẬP MÃ</button>
                                </div>
                            </div>
                        </form>
                        <script type="text/javascript">
            ...
            <div class="notify-box" class="" data-step="3" id="step3">
                <div>
                    <h2>CHÚC MỪNG BẠN<br/>ĐĂNG KÝ THÀNH CÔNG</h2>
                    <div>
                        <form name="phoneFrm" id="phoneFrm" class="frm">
                            <div class="ctrl pdb mes">
                                <div class="text-center"><span class="fa fa-check-circle" style="color:#ffdd00;font-size:60px;padding:20px"></span></div>
                                Chúc mừng bạn đã đăng ký thành công.<br/>
                                Vui lòng đăng nhập để tiếp tục đăng tin.
                                Xin cảm ơn.
                            </div>
                        </form>
                    </div>
                    <div class="dfoot foot-btns">
                        <div ><div class="text-left"><a  href="taikhoan.html" >Tài Khoản Của Tôi</a></div></div>
