            ...
            <div class="con pdl pdr">
                <div class="breadcrumb bec-fu">
                    <ul>
                        ...
                        <li><a href="ban.html">Nhà Đất Bán</a></li>
            ...
            <div class="con cls-after">
                ...
                <div class="con-left pda">
                    ...
                    <div class="tit mgt">
                        <p>NHÀ ĐẤT BÁN</p>
                        <div class="act">
                            <a href="ban.html" class="more a"><span class="smtext">Xem tất cả</span> <span class="fa fa-angle-right"></span></a>
                        </div>
                    </div>
                    ...
                    <div class="paging">
                        <ul>
                            <li><a href="ban.html"><span class="fa fa-angle-double-left"></span></a></li>
                            <li><a href="ban.html"><span class="fa fa-angle-left"></span></a></li>
                            <li><a href="ban.html">1</a></li>
                            <li class="active"><a href="ban2.html">2</a></li>
                            <li><a href="ban2.html"><span class="fa fa-angle-right"></span></a></li>
                            <li><a href="ban2.html"><span class="fa fa-angle-double-right"></span></a></li>
                        </ul>
                    </div>
                    <!-- PAGING END -->
                </div>
