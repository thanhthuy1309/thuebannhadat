        ...
        <div class="wrap">
            ...
            <div class="con pda">
                <div class="tit">
                    ...
                    <div class="act">
                        ...
                        <a href="mua-list.html" class="more a"><span class="smtext">Xem tất cả</span> <span class="fa fa-angle-right"></span></a>
                    </div>
                </div>
            ...
            <div class="con cls-after">
                ...
                <div class="con-left pda">
                    ...
                    <div class="paging">
                        <ul>
                            <li><a href="mua.html"><span class="fa fa-angle-double-left"></span></a></li>
                            <li><a href="mua.html"><span class="fa fa-angle-left"></span></a></li>
                            <li class="active"><a href="mua.html">1</a></li>
                            <li><a href="mua2.html">2</a></li>
                            <li><a href="mua3.html">3</a></li>
                            <li><a href="mua4.html">4</a></li>
                            <li><a href="mua5.html">5</a></li>
                            <li><a href="mua6.html">6</a></li>
                            <li><a href="mua2.html"><span class="fa fa-angle-right"></span></a></li>
                            <li><a href="mua6.html"><span class="fa fa-angle-double-right"></span></a></li>
                        </ul>
                    </div>
                    <!-- PAGING END -->
                </div>
