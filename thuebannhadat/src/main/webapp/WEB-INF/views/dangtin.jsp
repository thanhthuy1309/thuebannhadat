...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/lib/jquery.nicescroll.min.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/lib/jquery.mCustomScrollbar.concat.min.js"></script>
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/lib/ckeditor/ckeditor.js" ></script>
                ...
                <div class="con-left pda">
                    ...
                    <div class="open" data-step="1" id="step1">
                        <div class="tit fix-xs">
                            <p>ĐĂNG TIN BÁN</p>
                            <div class="act">
                                <a href="dangtin.html" class="more a active">Bán / Cho Thuê</a>
                                <a href="dangtin-thue.html" class="more">Mua / Thuê</a>
                            </div>
                        </div>
                        <div class="noti">
                            <b><u>Lưu ý</u></b> :<br/>
                        ...
                        <div class="form custom-form">
                            ...
                            <div class="uploads">
                                <div >
                                    <div id="nicescroll" class="${pageContext.request.contextPath}/resources/images cls-after">
                                        <div>
                                            <div class="item">
                                                <div class="nailthumb">
                                    ...
                                    <div class="item add-image" onclick="$(this).toggleClass('uploading')">
                                        <div class="nailthumb">
                                            <div class="nailthumb-figure-square">
                            ...
                            <div class="box">
                                <div class="row">
                                    <div><label>Link Video ( Neu co )</label></div>
                                    <div class="link">
                                        <span>http://</span>
