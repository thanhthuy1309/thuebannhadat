    ...
    <body class="">
        ...
        <div class="wrap">
            ...
            <div class="banner cover" style="background-image:url(${pageContext.request.contextPath}/resources/images/15.jpg)">
                <div class="con">
                    <div class="tit-big">COCOBAY ĐÀ NĂNG</div>
                    <div class="breadcrumb">
                        <ul>
                            <li><a href="trangchu.html"><i class="fa fa-home"></i> Trang Chủ</a></li>
                            <li><a href="duan.html">Dự án</a></li>
                            <li><a href="duan.html">Chung cư cao cấp</a></li>
                            <li><span>COCO bay</span></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="con cls-after">
                <div class=" pda">
                    <div class="wh-tabs">
                        <ul class="cls-after">
                            <li class="active"><a href="JavaScript:">Tổng quan</a></li>
                            <li class=""><a href="JavaScript:">Vi Tri</a></li>
                            <li class=""><a href="JavaScript:">Co So Ha Tang</a></li>
                            <li class=""><a href="JavaScript:">Thiet ke - Nha Mau</a></li>
                            <li class=""><a href="JavaScript:">Ho Tro Tai Chinh</a></li>
                        </ul>
                    ...
                    <!-- <div class="news-items cls-after"> -->
                        <div class="news-item">
                            ...
                            <div class="info" style="height:190px">
                                ...
                                <a href="duan-chitiet.html" class="yellow-btn block-btn hvr-bounce-to-bottom">Chi Tiết</a>
                            </div>
                        </div>
                        <div class="news-item">
                            <div class="nailthumb">
