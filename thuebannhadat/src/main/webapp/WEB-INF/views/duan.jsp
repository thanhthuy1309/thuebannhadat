        ...
        <div class="wrap">
                                    ...
                                    <div class="cls-after">
                                        ...
                                        <div class="s-item">
                                            <div class="search-btn">
                                                <a href="timkiem.html" class="block-btn yellow-btn hvr-bounce-to-bottom">Tìm Kiếm</a>
            ...
            <div class="con pda">
                <div class="tit">
                    ...
                    <div class="act">
                        ...
                        <a href="duan-list.html" class="more a"><span class="smtext">Xem tất cả</span> <span class="fa fa-angle-right"></span></a>
                    </div>
                </div>
                <!-- SLIDER BEGIN -->
                <div class="hot-project">
                    <div id="owl-project-slider" class="owl-carousel owl-project-slider">
                        <div class="item cover" style="background-image:url(${pageContext.request.contextPath}/resources/images/13.jpg)" data-hash="one">
                            <div class="transition">
                                <div>DỰ ÁN KHU NGHỈ DƯỠNG RIVERSIDE CITY</div>
                                <p>44 - 46 Đường Lê Thánh Tôn giao Nguyễn Thiện Thuật, TP. Nha Trang</p>
                            </div>
                        </div>
                        <div class="item cover" style="background-image:url(${pageContext.request.contextPath}/resources/images/14.jpg)" data-hash="two">
                            <div class="transition">
                                <div>DỰ ÁN KHU NGHỈ DƯỠNG RIVERSIDE CITY</div>
                                <p>44 - 46 Đường Lê Thánh Tôn giao Nguyễn Thiện Thuật, TP. Nha Trang</p>
                            </div>
                        </div>
                        <div class="item cover" style="background-image:url(${pageContext.request.contextPath}/resources/images/14.jpg)" data-hash="three">
                            <div class="transition">
                                <div>DỰ ÁN KHU NGHỈ DƯỠNG RIVERSIDE CITY</div>
                                <p>44 - 46 Đường Lê Thánh Tôn giao Nguyễn Thiện Thuật, TP. Nha Trang</p>
                            </div>
                        </div>
                        <div class="item cover" style="background-image:url(${pageContext.request.contextPath}/resources/images/14.jpg)" data-hash="four">
                            <div class="transition">
                                <div>DỰ ÁN KHU NGHỈ DƯỠNG RIVERSIDE CITY</div>
                                <p>44 - 46 Đường Lê Thánh Tôn giao Nguyễn Thiện Thuật, TP. Nha Trang</p>
                            </div>
                        </div>
                        <div class="item cover" style="background-image:url(${pageContext.request.contextPath}/resources/images/14.jpg)" data-hash="five">
                            <div class="transition">
                                <div>DỰ ÁN KHU NGHỈ DƯỠNG RIVERSIDE CITY</div>
                                <p>44 - 46 Đường Lê Thánh Tôn giao Nguyễn Thiện Thuật, TP. Nha Trang</p>
                            </div>
                    ...
                    <div class="thumb-navs">
                        <a href="#one" class="thumb-nav active">
                            <div class="thumb"></div>
                            <div class="cap">
                                <div>DỰ ÁN KHU NGHỈ DƯỠNG RIVERSIDE CITY</div>
                                <p>44 - 46 Đường Lê Thánh Tôn giao Nguyễn Thiện Thuật, TP. Nha Trang</p>
            ...
            <div class="con cls-after">
                ...
                <div class="con-left pda">
                        ...
                        <div class="item cls-after">
                            <div class="nailthumb">
                                <div class="nailthumb-figure-64">
                                    <a href="duan-chitiet.html" class="nailthumb-container">
                            ...
                            <div class="info">
                                ...
                                <table>
                                    <tr>
                                        <th colspan="6"><a href="duan-chitiet.html">Biệt thự Golden</a></th>
                                    </tr>
                                    <tr>
                                        <td colspan="6" class="dc-ico adds">Địa chỉ 108 Tôn Đức Thắng, P. Bến Thành, Q.1, TP.HCM</td>
                                    </tr>
                                    <tr>
                                        <td colspan="6">- Tổng Diện tích 6000ha<br/>- Diện tích đất ở 3200ha<br/>- Diện tích cây xanh, mặt nước, dịch vụ 2000ha<br/>- Diện tích giao thông ký thuật 30%</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-more" colspan="2" ><a href="duan-chitiet.html" class="yellow-btn">CHI TIẾT <span class="fa fa-angle-right"></span></a></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                    ...
                    <div class="paging">
                        <ul>
                            <li><a href="duan.html"><span class="fa fa-angle-double-left"></span></a></li>
                            <li><a href="duan.html"><span class="fa fa-angle-left"></span></a></li>
                            <li class="active"><a href="duan.html">1</a></li>
                            <li><a href="duan2.html">2</a></li>
                            <li><a href="duan2.html"><span class="fa fa-angle-right"></span></a></li>
                            <li><a href="duan2.html"><span class="fa fa-angle-double-right"></span></a></li>
                        </ul>
                    </div>
                    <!-- PAGING END -->
                </div>
                ...
                <div class="pda">
                    ...
                    <div class="news-items cls-after">
                        <div class="item">
                            ...
                            <div class="info">
                                <a href="JavaScript:void(0)" class="h3">[Lorem Ipsum] is simply dummy text of the printing and typesetting industry</a>
                                <p>
