...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/lib/swipebox/jquery.swipebox-1.3.js"></script>
        ...
        <div class="wrap">
            ...
            <div class="con pda ">
                <div class="detail-box">
                    <div class="medias">
                        ...
                        <div id="vvideo" class="cover" style="background-image:url(${pageContext.request.contextPath}/resources/images/24.jpg)">
                            <a href="#" class="play"></a>
                        </div>
                    </div>
                    <div class="acts">
                        <div class="active" data-elm="vimage"><img src="${pageContext.request.contextPath}/resources/images/xh.png"/></div>
                        <div class="" data-elm="vmap" onclick="init()"><img src="${pageContext.request.contextPath}/resources/images/bd.png"/></div>
                        <div class="" data-elm="vvideo"><img src="${pageContext.request.contextPath}/resources/images/vd.png"/></div>
                    </div>
                    <div class="info">
                        <div class="h1">
                        ...
                        <p class="pdb"><span class="fa fa-map-marker"></span> Địa chỉ 108 Tôn Đức Thắng, P. Bến Thành, Q.1, TP.HCM</p>
                        <div class="big-ifs">
                            <div class="big-price">3200 TỶ</div>
                            <div class="big-if"><img src="${pageContext.request.contextPath}/resources/images/ico61.png"/> <span>Gara : 1</span></div>
                            <div class="big-if"><img src="${pageContext.request.contextPath}/resources/images/ico62.png"/> <span>Phòng Ngủ : 3</span></div>
                            <div class="big-if"><img src="${pageContext.request.contextPath}/resources/images/ico63.png"/> <span>Phòng Tắm : 3</span></div>
                            <div class="big-if"><img src="${pageContext.request.contextPath}/resources/images/ico64.png"/> <span>Diện Tích : 100m</span></div>
                        </div>
                        <div class="servs">
                            <div><strong>Tiện Ích Xung Quanh</strong></div>
                            <div class="big-if"><img src="${pageContext.request.contextPath}/resources/images/ico65.png"/> <span>Gần Trường Học</span></div>
                            <div class="big-if"><img src="${pageContext.request.contextPath}/resources/images/ico66.png"/> <span>Gần Bệnh Viện</span></div>
                            <div class="big-if"><img src="${pageContext.request.contextPath}/resources/images/ico67.png"/> <span>Gần Trường Học</span></div>
                            <div class="big-if"><img src="${pageContext.request.contextPath}/resources/images/ico68.png"/> <span>An Ninh Tốt</span></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="con cls-after">
                ...
                <div class="con-left pda">
                    ...
                    <div class="social2">
                        ...
                        <a href="#" ><span class="fa fa-google"></span> Google</a>
                        <a href="#" ><span class="fa fa-skype"></span> Skype</a>
                ...
                <div class="con-right pda">
                    <div class="saler cls-after">
                        <a href="JavaScript:void(0)">
                            <img src="${pageContext.request.contextPath}/resources/images/22.jpg">
                        </a>
                        <div class="tit-big un-tit">NGUYEN VAN TEO</div>
                        <div class="pda">
                            Liên hệ người bán<br/><br/>
                            <span class="fa fa-phone"></span> 09xx xxx xxx<br/>
                            <span class="fa fa-send"></span> Info@gmail.com<br/>
                            <span class="fa fa-skype"></span> nguyenvanteo<br/>
                        </div>
                    </div>
                </div>
                <!-- RIGHT END -->
                                ...
                                <div class="nailthumb">
                                    <div class="nailthumb-figure">
                                        <div class="nailthumb-container">
                                            <img class="lazy" src="${pageContext.request.contextPath}/resources/images/14.png">
                                        </div>
                                        <a href="${pageContext.request.contextPath}/resources/images/14.png" title="Sơ đồ nhà" class="nailthumb-mark swipebox"></a>
                                    </div>
                                </div>
                            </div>
                            <div class="item">
                ...
                <div>
                    ...
                    <div class="con-left pda">
                        ...
                        <table class="table detail">
                            ...
                            <tr>
                                <td>Ngân hàng hỗ trợ vay<br/>Với lãi xuất ưu đãi</td>
                                <td width="120"><img onclick="dialog('bank-dialog')" src="${pageContext.request.contextPath}/resources/images/banks.png"></td>
                            </tr>
                        </table>
                    ...
                    <div class="con-right pda">
                        <div class="cha">
                                <img src="${pageContext.request.contextPath}/resources/images/ch.png">
                        </div>
                    </div>
                    <!-- RIGHT END -->
                </div>
            ...
            <div class="con cls-after">
                <div class="pda">
                    ...
                    <div id="owl-service" class="owl-carousel owl-news services related-services">
                        ...
                        <div class="news-item">
                            ...
                            <div class="info">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td class="adds"><span class="fa fa-user"></span> Nova Land Group</td>
                                        <td class="adds"><span class="fa fa-calendar"></span> 12/08/2016</td>
                ...
                <div style="max-width:720px">
                    ...
                    <div class="body">
                        <form name="pinFrm" id="pinFrm" class="form custom-form bank-frm">
                            <table>
                                <tr>
                                    <td><img height="30" src="http://www.acb.com.vn/wps/wcm/connect/f6798828-b0d3-4061-8581-f7ee2b9c1d68/logo-acb.png?MOD=AJPERES&CACHEID=f6798828-b0d3-4061-8581-f7ee2b9c1d68"/></td>
                            ...
                            <fieldset>
                                ...
                                <div class="pdt">
                                    <button class="yellow-btn hvr-bounce-to-bottom" onclick="dialog('bank-dialog')" type="button">ĐỒNG Ý</button>
                                </div>
                        </form>
                    </div>
                </div>
