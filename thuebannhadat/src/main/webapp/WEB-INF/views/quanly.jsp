...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/lib/datepicker/datetimepicker.min.css"/>
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/lib/datepicker/moment.min.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/jquery-1.9.1.min.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/lib/plugin.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/lib/datepicker/datetimepicker.min.js"></script>
                ...
                <div class="con-right pda">
                    <div class="acc-info">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="quanly.html"><span class="fa fa-newspaper-o"></span> Quản Lý Tin</a></li>
                            <li class=""><a href="taikhoan.html"><span class="fa fa-user"></span> Thông tin tài khoản</a></li>
                            <li class=""><a href="lichsu.html"><span class="fa fa-history"></span> Lịch sử giao dịch</a></li>
                    ...
                    <div data-step="2-1" id="step2-1" class="open ">
                        ...
                        <div class="box mgb">
                            <table class="sum-avg">
                                <tr>
                                    <td>Tất Cả : 1</td>
                                    <td>Đã kích hoạt : 1</td>
                                    <td>Đang chờ : 1</td>
                                    <td>Đã xóa : 1</td>
                                </tr>   
                            </table>
                        </div>
                        <div class="sort-box cls-after">
                            <div class="pdb">
                                <div class="input-group">
                                    <div class="pdr">Lọc theo</div>
                                    <div class="pdr">
                                        <div class="control">
                                            <div class="cbx cbx-se cbx-sort">
                                                <a href="JavaScript:void(0)" class="btn" data-toggle="dropdown"
                                                ><span>Thông Thường <i class="fa fa-caret-down"></i></span></a>
                                                <div class="cbx-menu">
                                                    <ul>
                        ...
                        <div class="box mgt">
                            <table class="histable colors">
                                <tr>
                                    <td >
                                        <img src="${pageContext.request.contextPath}/resources/images/5.jpg" width="80">
                                    </td>
                                    <td >
                                        <div><strong>Bán nhà quận 3</strong></div>
                                        <div class="fx0"><span class="label g">Đã Duyệt</span></div>
                                        <div class="fx0">2016/10/12</div>
                                    </td>
                                    <td >
                                        <div class="fx0">Hết hạn : 2016/10/12</div>
                                    </td>
                                    <td >
                                        <span class="label">Up Tin</span>
                                    </td>
                                    <td >
                                        <span class="label">Làm Mới</span>
                                    </td>
                                    <td >
                                        <span class="label">Mua tin</span>
                                    </td>
                                    <td class="text-center">
                                        <a href="dangtin.html" class="fa fa-pencil"></a>
