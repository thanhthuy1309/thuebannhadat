...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/${pageContext.request.contextPath}/resources/lib/swipebox/swipebox-dark-1.3.css" >
        ...
        <div class="wrap">
            ...
            <div class="con pdl pdr">
                <div class="breadcrumb bec-fu">
                    <ul>
                        ...
                        <li><a href="thue.html">Cho Thuê</a></li>
                        ...
                        <div class="hot-items">
                            <div>
                                <div class="item">
                                    <div class="nailthumb">
                                        <div class="nailthumb-figure-75">
                                            <a href="chitiet.html" class="nailthumb-container">
                                                <img class="lazy" src="${pageContext.request.contextPath}/resources/images/1.jpg">
                                            </a>
                                            <a href="chitiet.html" class="info">
                                                <div>
            ...
            <div class="con cls-after">
                ...
                <div class="con-left pda">
                    ...
                    <!-- SORT BEGIN -->
                    <div class="con pdb" style="z-index:29;position:relative">
                    ...
                    <div class="tit mgt">
                        <p>NHÀ ĐẤT THUÊ</p>
                        <div class="act">
                            <a href="thue.html" class="more a"><span class="smtext">Xem tất cả</span> <span class="fa fa-angle-right"></span></a>
                        </div>
                    </div>
                        ...
                        <div class="item cls-after">
                            ...
                            <div class="info">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td class="dt-ico" width="100" colspan="3">Diện tích: 125m2</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-more" colspan="2" ><a href="chitiet.html" class="yellow-btn">CHI TIẾT <span class="fa fa-angle-right"></span></a></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                    ...
                    <div class="paging">
                        <ul>
                            <li><a href="thue.html"><span class="fa fa-angle-double-left"></span></a></li>
                            <li><a href="thue.html"><span class="fa fa-angle-left"></span></a></li>
                            <li><a href="thue.html">1</a></li>
                            <li class="active"><a href="thue2.html">2</a></li>
                            <li><a href="thue2.html"><span class="fa fa-angle-right"></span></a></li>
                            <li><a href="thue2.html"><span class="fa fa-angle-double-right"></span></a></li>
                        </ul>
                    </div>
                    <!-- PAGING END -->
                </div>
