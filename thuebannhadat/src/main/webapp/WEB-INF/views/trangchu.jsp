                            ...
                            <div class="">
                                <div class="slider-content transition">
                                    ...
                                    <div>
                                        <table>
                                            <tr>
                                                <td colspan="2" class="dc-ico">Địa chỉ 108 Tôn Đức Thắng, P. Bến Thành, Q.1, TP.HCM</td>
                                            </tr>
                                            <tr>
            ...
            <div class="con pda">
                <div class="tit">
                    ...
                    <div class="act">
                        ...
                        <a href="ban-list.html" class="more a"><span class="smtext">Xem tất cả</span> <span class="fa fa-angle-right"></span></a>
                    </div>
                </div>
                ...
                <div class="con-left pda">
                            ...
                            <div class="info">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-more" colspan="2" ><a href="ban.html" class="yellow-btn">CHI TIẾT <span class="fa fa-angle-right"></span></a></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                    ...
                    <div class="items cls-after grid">
                        <div class="item cls-after">
                            <div class="nailthumb">
                                <div class="nailthumb-figure-64">
                                    <a href="thue.html" class="nailthumb-container">
                            ...
                            <div class="info">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td class="adds" colspan="2"><span class="fa fa-user"></span> Nova Land Group</td>
                                        <td class="adds" colspan="2"><span class="fa fa-calendar"></span> 12/08/2016</td>
                                        <td class="td-more" colspan="2" ><a href="thue.html" class="yellow-btn">CHI TIẾT <span class="fa fa-angle-right"></span></a></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                ...
                <div class="pda">
                    ...
                    <div class="news-items cls-after">
                        <div class="item">
                            ...
                            <div class="info">
                                <a href="tintuc-detail.html" class="h3">[Lorem Ipsum] is simply dummy text of the printing and typesetting industry</a>
                                <p>
