        ...
        <div class="wrap">
            ...
            <div class="con pda ">
                <div class="detail-box">
                        ...
                        function init() {
                            ...
                            var content_info ='\
                                  <div style="width:360px;font-size:13px;">\
                                      ...
                                      <div><h4 style="margin:0;padding:4px 0;color:#ee4034">THUÊ BÁN NHÀ ĐẤT</h4></div>\
                    ...
                    <div class="info">
                        <p class="pdt"><span class="fa fa-map-marker"></span> Địa chỉ 108 Tôn Đức Thắng, P. Bến Thành, Q.1, TP.HCM</p>
                    </div>
                </div>
            </div>
            <!-- SLIDER END -->
            ...
            <div class="con cls-after">
                ...
                <div class=" pda">
                    ...
                    <div class="mgb pdb mgt">
                        VĂN PHÒNG CÔNG TYTHUÊ BÁN NHÀ ĐẤT<br/>
                        <span class="fa fa-map-marker"></span> Địa chỉ 108 Tôn Đức Thắng, P. Bến Thành, Q.1, TP.HCM<br>
                        <span class="fa fa-phone"></span> 09xx xxxx xxx/09xx xxxx xxx &nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-envelope-o"></span> hotro@thuebannhadat.com
                    </div>
                    <div class="mgb pdb form">
                    <p>GỬI THÔNG TIN CHO CHÚNG TÔI:</p>
                        <form id="myFrm" name="myFrm">
                            <table class="table contact-tb">
                                <tr>
                                ...
                                <tr>
                                    <td>Tiêu đề (<span class="red">*</span>)</td>
                                    <td>
                                        <input type="text" class="txt validate[required]">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <textarea rows="10" class="txt validate[required]" id="content" style="width:240px"></textarea>
                                        <script type="text/javascript">
                                                // addEditorBasic('content',240)
                                                addRedactorEditor($('#content'),120)
                                        </script>
                                    </td>
                                </tr>
                            </table>
